...
public class Ejercicios421 {
	...
	public static void main(String[] args) {
		...
		//dos StringBuilder, utilizando append y también 
		...
		//de un StringBuilder.
		StringBuilder strb5 = 
						new StringBuilder("Ayer cayó un rayo");
	    ...
	    for(int i=0;i<conv.length();i++) {
	    	...
	    	//Poner solo una letra mayúscula
